...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, required=False, default=22,
        help = "Batch size for train, default=%(default)s")
    ...
    parser.add_argument('--transfer_epoch', type=int, required=False, default=130,
                        help="Transfer training (from Imagenet) stage epochs, default=%(default)s")
    ...
    parser.add_argument('--total_epoch', type=int,required=False, default=130,
        help = "Total training epochs, default=%(default)s // 전체 Epoch :초기 Default 값은 250이었음")
